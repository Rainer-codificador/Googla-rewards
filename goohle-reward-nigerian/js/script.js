...
function loadVSLPlayer() {
    ...
    // INSERIR O CÓDIGO DO PLAYER VSL SUBSTITUÍDO
    playerContainer.innerHTML = `
        <vturb-smartplayer id="vid-69045e8bb6b436ae570eedd0" style="display: block; margin: 0 auto; width: 100%; max-width: 400px;"></vturb-smartplayer>
    `;
    
    // Carregar o script do player
    const script = document.createElement("script");
    script.src = "https://scripts.converteai.net/db071d95-c683-42c2-9d99-de31ebd8e50d/players/69045e8bb6b436ae570eedd0/v4/player.js";
    script.async = true;
